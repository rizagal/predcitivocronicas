...
if(selected == 'Consulta Resultado Indicadores de Oportunidad'):
    ...
    if (ips != 'Seleccione'):
      ...
      id_registrocontador = id_registrocontador.replace(" ", "")
      database.child("ipsconsultaindicadores").child(id_registrocontador[0:14]).update({'id':id_registrocontador,'nombre':ips,'fecha_consulta':hora_actual[0:10],'contador':1})   
