...
if(selected == 'Consulta Resultado Indicadores Atencion al Usuario'):
    ...
    with col2:
       ...
       st.dataframe(dfpqrs_selection.style.apply(color_negative_redusuario, subset=['TOTAL']).format({"TOTAL": "{:.1}"}),hide_index=True,height=450,use_container_width=True,column_order=("EVALUACION","MES","PETICIONES","QUEJAS","RECLAMOS","NOMBREIPS"))
